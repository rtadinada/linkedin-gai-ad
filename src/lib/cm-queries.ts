...
export async function createCampaign(name: string, postHeaders: object): Promise<string> {
...
export async function uploadImage(url: string, postHeaders: object): Promise<string> {
    ...
    console.log({ registerReqeust: { requestBody, options } });
    ...
    if (!registerDataHolder.value) {
        console.log({ registerDataHolder });
